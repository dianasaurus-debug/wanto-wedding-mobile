...
class DaftarCatering extends StatefulWidget {
  @override
  _DaftarCateringState createState() => _DaftarCateringState();
}

class _DaftarCateringState extends State<DaftarCatering> {
  final formatCurrency = new NumberFormat.simpleCurrency(locale: 'id_ID');
  late Future<List<Vendor>> futureVendorCatering;
  bool isAuth = false;
  ...
  void initState() {
    ...
    futureVendorCatering = isAuth == true ? VendorNetwork().getVendor("3") : VendorNetwork().getVendorGlobal("3");
  }
